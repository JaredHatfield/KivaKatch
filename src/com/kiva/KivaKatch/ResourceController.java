...
public class ResourceController {
	...
	/**
	 * The list of Lenders that have been retrieved.
	 * This is a soft reference map so this buffer can be cleared at any time.
	 */
	private Map<String, SoftReference<Lenders>> lenders;
	
	/**
	 * The list of profile pictures that have been retreived.
	 * This is a soft reference map so this buffer can be cleared at any time.
	 */
	...
	public Lenders getLender(String name) throws LenderCreationException{
		...
		if(soft != null){
			...
			if(lender != null){
				...
				// Remove the entry in the Map, we will add it back in the next step.
	 ...
	 * @param imageId The id of the picture to retrieve.
