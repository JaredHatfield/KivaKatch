...
public class Lenders {
	 ...
	 * @param member_since The new member_since.
	 */
	 ...
	 * @param personal_url The new personal_url.
	 */
	 ...
	 * @param loan_because The new loan_because.
	 */
	public void setLoanBecause(String loan_because){
		this.loan_because = loan_because;
	}
	
	/**
	 * Sets the value of occupational_info.
	 * @param occupational_info The new occupational_info.
	 */
	public void setOccupationalInfo(String occupational_info){
		this.occupational_info = occupational_info;
	}
	
	/**
	 * Sets the value of loan_count.
	 * @param loan_count The new loan_count.
	 */
	public void setLoanCount(String loan_count){
		this.loan_count = loan_count;
	}
	
	/**
	 * Sets the value of invitee_count.
	 * @param invitee_count The new invitee_count.
	 */
	public void setInviteeCount(String invitee_count){
